    ...
    <Box width="100%" flex={1} bg={"background"}>
      ...
      >
        ...
        <Box width="100%" alignItems={"center"}>
          <Text marginTop={8} fontSize={22} fontWeight={500} color={"#00689d"}>
            Informações da Praia
          </Text>
        </Box>
        <Box mx={5}>
          <Text fontWeight="bold" marginTop={5} fontSize={16} marginBottom={1}>
            Nome da Praia:
          </Text>
          <Text fontSize={16}>{mockData.name}</Text>
          <Text fontWeight="bold" marginTop={4} fontSize={16} marginBottom={1}>
            Cidade/Estado:
          </Text>
          <Text fontSize={16}>
